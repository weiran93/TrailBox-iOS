...
仓库根目录是 `/Users/zhaoweiran/projects/TrailBox`：

```
TrailBox/
├── AGENTS.md              # 本文件（iOS 项目级）
├── README.md              # 仓库总说明（偏 PWA/后端）
├── HANDOVER.md            # PWA 交接文档
├── api/                   # FastAPI 后端
├── web/                   # PWA 前端
├── ios/TrailBox/          # iOS 原生客户端
│   ├── TrailBox.xcodeproj
│   └── TrailBox/          # 源码目录
└── ...
```
...
1. 打开 `ios/TrailBox/TrailBox.xcodeproj`
...
```bash
cd /Users/zhaoweiran/projects/TrailBox/ios/TrailBox
